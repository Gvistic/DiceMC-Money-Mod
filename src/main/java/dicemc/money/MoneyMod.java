...
import dicemc.money.commands.EcoCommand;
import dicemc.money.commands.PayCommand;
import dicemc.money.commands.AuctionCommand;
...
public class MoneyMod {
	...
	public enum AcctTypes {
		...
		AcctTypes(ResourceLocation res) {
			key = res;
		}
	}
